 ...
 * @parameter[in]	-None
 * @return value    -None
 * Note				-It sets all rows and columns of keypad as Outputs(push-pull) 10MHz speed
 */
void Keypad_init(void){
	...
	// Initialize the KEYPAD Port which is Port B with 0xFF
 ...
 * @parameter[in]	-None
 * @return value    -It returns a char (key pressed)
 * Note				-None
 */
char Keypad_getkey(void){

	volatile int i,j;  // Two counters for Two loops
